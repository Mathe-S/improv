...
export const improvGames: ImprovGame[] = [
  ...
  {
    name: "Experts",
    description: "An interview game where the 'expert' must instantly justify and answer absurd, impossible questions without hedging.",
    rules: [
      "One player is a TV interviewer, and the other is an 'expert' on an absurd subject.",
      "The interviewer should invent impossible questions by starting a sentence without knowing the end (e.g., 'How do you teach hippos to knit?').",
      "The expert must answer immediately and confidently, without hedging or waffling.",
      "The interviewer's job is to demand immediate specific answers and hold the expert to the problem.",
      "Embrace any answer given, no matter how ridiculous, and explore its logic.",
      "If the interviewer refers to imaginary charts or visiting soloists, the expert must confidently accept and provide them.",
    ],
    playerCount: "2",
    difficulty: "intermediate",
    slug: "experts",
